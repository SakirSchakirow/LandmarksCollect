...
import org.landmarkscollector.mlkit.FrameMetadata;
...
public class BitmapUtils {
     ...
     */
    @Nullable
    public static Bitmap getBitmap(ImageProxy image, Boolean flipX) {
     ...
     */
    @Nullable
    private static Bitmap getBitmap(ByteBuffer data, FrameMetadata metadata, Boolean flipX) {
        data.rewind();
        ...
        try {
            ...
            stream.close();
            return rotateBitmap(bmp, metadata.getRotation(), flipX, false);
        } catch (Exception e) {
